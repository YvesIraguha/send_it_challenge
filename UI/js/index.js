const options = `
          <select name="origin" class="origin">
              ...
              <option value="A ngola">Angola</option>
              ...
              <option value="Micronesia, Federated States of Pacific Ocean">Micronesia, Federated States of Pacific Ocean</option>
              ...
              <option value="San MarinoSan Marino">San Marino</option>
